...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container " style="width: 100%; padding-top: 6%;">
        <div class="well" style="text-align: center;">

            <asp:Label Text="Contact points displacement between LR3 and LR2" runat="server" Style="width: 100%;" CssClass="Labelhh" />
    ...
    <div class="container " style="width: 100%; margin-top: 20px;">
        <div class="well" style="text-align: center;">
            ...
            <asp:Label Text="Contact points displacement between LR2 and LR1" runat="server" Style="width: 100%;" CssClass="Labelhh" />
    ...
    <div class="container " style="width: 100%; margin-top: 20px;">
        <div class="well" style="text-align: center;">
            ...
            <asp:Label Text="Contact Points displacement between LR1 and LL1" runat="server" Style="width: 100%;" CssClass="Labelhh" />
    ...
    <div class="container " style="width: 100%; margin-top: 20px;">
        <div class="well" style="text-align: center;">
            ...
            <asp:Label Text="Contact points displacement between LL2 and LL1" runat="server" Style="width: 100%;" CssClass="Labelhh" />
    ...
    <div class="container " style="width: 100%; margin-top: 20px;">
        <div class="well" style="text-align: center;">
            ...
            <asp:Label Text="Contact points displacement between LL3 and LL2" runat="server" Style="width: 100%;" CssClass="Labelhh" />
    ...
    <div class="container">
        ...
        <div class="container" style="text-align: end; margin-top: 15px;">
            <asp:Label runat="server" ID="showing_error" CssClass="text-danger  text-right" Visible="false" Text="Please Complete all domains to Continue" Width="100%" />
