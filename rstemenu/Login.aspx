...
<div class="login_content">
  ...
  <LayoutTemplate>         
       ...
       <img src="images/parslogo.png">
        <h1>Login </h2>
            ...
            <div class="pass_input_field">
                <asp:TextBox ID="Password" runat="server" CssClass="passwordEntry"  TextMode="Password" placeholder="password" required="required" ></asp:TextBox>
         ...
         <div id="LoginUser_LoginUserValidationSummary" class="failureNotification"  ></div>
          ...
          <p>
                    <asp:HyperLink runat="server" Font-Size="Medium" ForeColor="Gray" ID="RegisterHyperLink" ViewStateMode="Disabled" NavigateUrl="~/Register.aspx" >Register as a New User</asp:HyperLink>
                </p>
    ...
    <div style="text-align:center;">
            <img src="images/orthoparnewimage.jpg" width="90%" />
